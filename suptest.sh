...
/opt/local/bin/erl -noshell -K true +P 10000 -env ERL_MAX_PORTS 10000 -pa ebin -pa deps/lager/ebin -pa deps/goldrush/ebin -boot start_sasl -name suptest@richsmac.ecollege-dev.com -setcookie COOKIE -eval "application:start(suptest)." >> /dev/null &
